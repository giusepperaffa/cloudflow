...
# Test Functions
# ==============
@pytest.mark.yaml_test_file(__file__, 'serverless_one_handler_only.yml')
def test_one_handler_only(get_yaml_test_file_dict):
...
@pytest.mark.yaml_test_file(__file__, 'serverless_one_handler_one_event.yml')
def test_one_handler_one_event(get_yaml_test_file_dict):
    he_identifier_obj = HandlersEventsIdentifierCls(get_yaml_test_file_dict)
...
@pytest.mark.yaml_test_file(__file__, 'serverless_handlers_with_and_without_events.yml')
def test_handlers_with_and_without_events(get_yaml_test_file_dict):
    he_identifier_obj = HandlersEventsIdentifierCls(get_yaml_test_file_dict)
...
@pytest.mark.yaml_test_file(__file__, 'serverless_multi_events_from_same_service.yml')
def test_multi_events_from_same_service(get_yaml_test_file_dict):
    he_identifier_obj = HandlersEventsIdentifierCls(get_yaml_test_file_dict)
...
def test_one_event_via_string(get_yaml_test_file_dict):
    he_identifier_obj = HandlersEventsIdentifierCls(get_yaml_test_file_dict)
...
@pytest.mark.yaml_test_file(__file__, 'serverless_multi_events_from_same_service_via_strings.yml')
def test_multi_events_via_strings(get_yaml_test_file_dict):
    he_identifier_obj = HandlersEventsIdentifierCls(get_yaml_test_file_dict)
    assert he_identifier_obj.get_num_of_handlers() == 2
    assert he_identifier_obj.get_num_of_events() == 2
